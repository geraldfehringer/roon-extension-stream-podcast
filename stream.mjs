...
const roon = re.init({
        ...
        extensionOptions: {
            extension_id:        'com.roongerilabs.roon_connect_stream_podcast',
            display_name:        'Roon Connect Podcast Streamer',
            display_version:     "1.0.0",
            publisher:           'gerihifi podcast streamer',
            email:               'contact@hificouch.world',
            website:             'https://github.com/geraldfehringer/roon-extension-stream-podcast',
        },
});
